...
export default function Home() {
  return (
    <Shell>
      <PageHeader title="Minden jó ajánlat egy kapcsolattal kezdődik." description="A DiscountDirect összeköti a vásárlási előzményeket, a személyes ajánlatokat és a tartós beszélgetéseket." eyebrow="Áttekintés" actions={<StatusBadge status="success" withIcon>1.3.0 · Mint circuit</StatusBadge>} />
      <EditorialHero
