...
export default function Home() {
  return (
    <Shell>
      <PageHeader title="Minden jó ajánlat egy kapcsolattal kezdődik." description="A DiscountDirect összeköti a vásárlási előzményeket, a személyes ajánlatokat és a beszélgetéseket." eyebrow="Áttekintés" actions={<StatusBadge status="success" withIcon>0.9.0 · Mint circuit</StatusBadge>} />
      <EditorialHero
