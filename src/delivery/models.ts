...
const deliveryOutboxSchema = new Schema(
  {
    ...
    newsletterSnapshotId: { type: Schema.Types.ObjectId, default: null, ref: "NewsletterSnapshot", index: true },
    journeyDefinitionId: { type: Schema.Types.ObjectId, default: null, ref: "JourneyDefinition", index: true },
    journeyEnrollmentId: { type: Schema.Types.ObjectId, default: null, ref: "JourneyEnrollment", index: true },
    journeyStepRunId: { type: Schema.Types.ObjectId, default: null, ref: "JourneyStepRun", index: true },
    kind: { type: String, enum: ["personal_offer", "flash_campaign", "automated_list", "printable_letter", "journey_step"], required: true },
    channel: { type: String, enum: ["in_app", "email", "postal", "whatsapp", "rcs"], required: true },
...
const deliverySuppressionSchema = new Schema(
  {
    ...
    buyerUserId: { type: Schema.Types.ObjectId, required: true, ref: "User", index: true },
    channel: { type: String, enum: ["email", "postal", "whatsapp", "rcs"], required: true },
