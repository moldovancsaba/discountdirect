...
const customerSchema = new Schema(
  {
    ...
    privacyStatus: {
      type: String,
      enum: ["active", "restricted", "erasure_requested", "erased"],
      default: "active",
      index: true,
    },
...
const purchaseSchema = new Schema(
  {
    ...
    status: {
      type: String,
      enum: ["purchased", "refunded", "corrected"],
      default: "purchased",
      index: true,
    },
    sourceName: { type: String, required: true, maxlength: 120 },
...
export const PurchaseImportBatch =
  models.PurchaseImportBatch ||
  model("PurchaseImportBatch", purchaseImportBatchSchema);
