...
const conversationEventSchema = new Schema(
  {
    ...
    sellerId: { type: Schema.Types.ObjectId, required: true, ref: "Seller", index: true },
    kind: { type: String, enum: ["message", "activity", "offer"], required: true },
    ...
    offerEventType: { type: String, enum: ["created", "accepted", "declined", "expired", "cancelled", null], default: null },
