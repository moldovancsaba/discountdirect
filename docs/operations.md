...
- UI/HTTP regression: use Vercel Instant Rollback to a previously verified deployment in the project deployment history; then revert the offending commit on GitHub and deploy again. Rollback has no database migration to reverse in 0.2.0. Never choose an unverified future deployment.
