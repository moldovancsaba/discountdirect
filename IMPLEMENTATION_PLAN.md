...
Board title: **{discountdirect} - From IDEA to LIVE**. Base its configuration on project #44, copying fields/views only and no ClassScout issues or draft items. Link it to this repository.
